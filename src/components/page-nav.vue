<template>
    <div>
        <el-menu :default-active="activeIndex" class="page-nav" style="position: fixed; width: 100%;z-index:1000" mode="horizontal" @select="handleSelect" router>
            <el-menu-item index="/about">
                <img src="@/assets/acm1-1.png" alt="logo" height="60px" width="60px">
            </el-menu-item>
            <el-menu-item index="/index" class="nav-item" route="/">竞赛首页</el-menu-item>
...
export default {
  ...
  methods: {
    handleSelect (key, keyPath) {
      console.log('NavChange:', key, keyPath)
    },
    handleCommand (command) {
      ...
      if (command === 'logout') {
        this.$store.commit('setuser', {isLogin: false, username: '登录/注册', isAdmin: false})
      }
      if (command === 'login') {
        this.$store.commit('setuser', {isLogin: true, username: 'Keadin', isAdmin: true})
      }
    }
  }
}
